...
import { BsBell, BsBookmark, BsBookmarks, BsEnvelope, BsTwitter } from "react-icons/bs";
    ...
    <div className="grid grid-cols-12 h-screen w-screen pl-56">
      <div className="col-span-3  pt-8">
       ...
       <div className="mt-4 text-2xl font-semibold pr-4">
        ...
        <button className="bg-[#1d9bf0] p-4 font-semibold text-lg rounded-full w-full " > Tweet</button>
       </div>
       </div>
      </div>
